  ...
  function main() {
    ...
    var cubeVertices = [
      ...
      -0.5,  0.5,   0.5,   1.0, 0.0, 0.0,
       ...
       0.5,  0.5,   0.5,   1.0, 0.0, 0.0,  //CDH CHG MERAH KANAN
       0.5, -0.5,   0.5,   1.0, 0.0, 0.0, 
       0.5, -0.5,  -0.5,   1.0, 0.0, 0.0, 
       0.5, -0.5,   0.5,   1.0, 0.0, 0.0, 
       0.5, -0.5,  -0.5,   1.0, 0.0, 0.0, 
       ...
       0.5, -0.5,   0.5,   1.0, 0.0, 0.0,  //DAE DEH MERAH BAWAH
      -0.5, -0.5,   0.5,   1.0, 0.0, 0.0, 
      -0.5, -0.5,  -0.5,   1.0, 0.0, 0.0, 
      -0.5, -0.5,   0.5,   1.0, 0.0, 0.0, 
      -0.5, -0.5,  -0.5,   1.0, 0.0, 0.0, 
      ...
      -0.5, -0.5,  -0.5,   1.0, 0.0, 0.0, //EFG EGH MERAH BELAKANG
      -0.5,  0.5,  -0.5,   1.0, 0.0, 0.0,
       0.5,  0.5,  -0.5,   1.0, 0.0, 0.0,
      -0.5,  0.5,  -0.5,   1.0, 0.0, 0.0,
       0.5,  0.5,  -0.5,   1.0, 0.0, 0.0,
      ...
      -0.5,  0.5,  -0.5,   1.0, 0.0, 0.0,  //FEA FAB MERAH KIRI
      -0.5, -0.5,  -0.5,   1.0, 0.0, 0.0, 
      -0.5, -0.5,   0.5,   1.0, 0.0, 0.0, 
      -0.5, -0.5,  -0.5,   1.0, 0.0, 0.0, 
      -0.5, -0.5,   0.5,   1.0, 0.0, 0.0, 
      ...
      -0.5,  0.5,   0.5,   1.0, 0.0, 0.0, 
       ...
       0.5,  0.5,  -0.5,   1.0, 0.0, 0.0, //GFB GBC MERAH ATAS
      -0.5,  0.5,  -0.5,   1.0, 0.0, 0.0,
      -0.5,  0.5,   0.5,   1.0, 0.0, 0.0,
      -0.5,  0.5,  -0.5,   1.0, 0.0, 0.0,
      -0.5,  0.5,   0.5,   1.0, 0.0, 0.0,
    ...
    +0.2, +0.5,    1.0, 1.0, 1.0,
    +0.26, +0.34,   1.0, 1.0, 1.0,

    +0.26, +0.34,    1.0, 1.0, 1.0,
    +0.1, -0.25,   1.0, 1.0, 1.0,
    +0.17, -0.25,   1.0, 1.0, 1.0,

    +0.2, +0.26,    1.0, 1.0, 1.0,
    +0.29, +0.08,    1.0, 1.0, 1.0,
    +0.285, +0.28,    1.0, 1.0, 1.0,
    ...
    +0.29, +0.08,   1.0, 1.0, 1.0,
    +0.385,+0.27,   1.0, 1.0, 1.0,
    +0.35,+0.5,   1.0, 1.0, 1.0,

    +0.385, +0.27,   1.0, 1.0, 1.0,
    +0.47,-0.25,   1.0, 1.0, 1.0,
    +0.395,-0.25,   1.0, 1.0, 1.0,

    +0.32, +0.30,   1.0, 1.0, 1.0,
    +0.385, +0.27,  1.0, 1.0, 1.0,
    +0.395,-0.25,   1.0, 1.0, 1.0,
    ]);
