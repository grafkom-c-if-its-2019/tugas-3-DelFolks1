(function(global) {
  ...
  function initBuffersTriangle() {
      var vertices = new Float32Array([
        ...
        +0.2, +0.5,    0.7, 0.0, 1.0,
        +0.26, +0.34,   0.1, 1.0, 0.6,

        +0.26, +0.34,    1.0, 1.0, 0.0,
        +0.1, -0.25,   0.7, 0.0, 1.0,
        +0.17, -0.25,   0.1, 1.0, 0.6,

        +0.2, +0.26,    1.0, 1.0, 0.0,
        +0.29, +0.08,    0.7, 0.0, 1.0,
        +0.285, +0.28,    0.1, 1.0, 0.6,

        +0.285, +0.28,   1.0, 1.0, 0.0,
        +0.2, +0.26,   0.7, 0.0, 1.0,
        +0.26, +0.34,   0.1, 1.0, 0.6,


        +0.285, +0.28,   1.0, 1.0, 0.0,
        +0.35,+0.5,   0.7, 0.0, 1.0,
        +0.29, +0.08,   0.1, 1.0, 0.6,

        +0.29, +0.08,   1.0, 1.0, 0.0,
        +0.385,+0.27,   0.7, 0.0, 1.0,
        +0.35,+0.5,   0.1, 1.0, 0.6,

        +0.385, +0.27,   1.0, 1.0, 0.0,
        +0.47,-0.25,   0.7, 0.0, 1.0,
        +0.395,-0.25,   0.1, 1.0, 0.6,

        +0.32, +0.30,   1.0, 1.0, 0.0,
        +0.385, +0.27,   0.7, 0.0, 1.0,
        +0.395,-0.25,   0.1, 1.0, 0.6,
...
/*          var theta2Loc = gl.getUniformLocation(program2,'theta2');
          ...
          theta2 += Math.PI * 0.0070;
          gl.uniform1f(theta2Loc, theta2);
*/
          if(isGrow) {scale += 0.0070}
          else{
              scale -= 0.0070;
          }
